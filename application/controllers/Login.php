...
class Login extends CI_Controller {
    ...
    public function index() {
        ...
        require_once "assets/google-api/vendor/autoload.php";
        ...
        $client->setRedirectUri('https://unityteam.madagascar.webcup.hodi.host/unity-webcup/Login');
        ...
        if(isset($_GET['code'])) {
            ...
            if(!isset($token['error'])) {
                ...
                $verif = $usr->googleLogin($data["email"],$data["name"]);
